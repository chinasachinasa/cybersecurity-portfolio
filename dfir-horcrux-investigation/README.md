...
System configuration (username, OS build, hostname, timezone)
Application usage (messaging software, browser version)
Communication analysis (external contacts, financial offers)
Document activity (file access times, source websites)
Security indicators (password changes, partition layout)
Skills Demonstrated
